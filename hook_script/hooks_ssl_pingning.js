...
*/
    ...
    HttpsURLConnection.setDefaultHostnameVerifier.implementation = function (hostnameVerifier) {
        quiet_send("HttpsURLConnection.setDefaultHostnameVerifier invoked" + ':' + hostnameVerifier);
        return true;
    };
    /* libcore/luni/src/main/java/javax/net/ssl/HttpsURLConnection.java */
    ...
    try {
        ...
        TrustManagerImpl.checkTrusted.overload('[Ljava.security.cert.X509Certificate;', 'java.lang.String', 'javax.net.ssl.SSLSession', 'javax.net.ssl.SSLParameters', 'boolean').implementation = function (chain, authType, session, parameters) {
            quiet_send("TrustManagerImpl checkTrusted called1");
            var k = array_list.$new();
            return k;
            //Generics currently result in java.lang.Object
            return Arrays.asList(chain);
        }
        TrustManagerImpl.checkTrusted.overload('[Ljava.security.cert.X509Certificate;', '[B', '[B', 'java.lang.String', 'java.lang.String', 'boolean').implementation = function (chain, authType, session, parameters) {
            quiet_send("TrustManagerImpl checkTrusted called2");
            //Generics currently result in java.lang.Object
            return Arrays.asList(chain);
        }
    ...
    TrustManagerImpl.checkTrustedRecursive.implementation = function (a1, a2, a3, a4, a5, a6) {
        quiet_send('checkTrustedRecursive found')
        var k = array_list.$new();
        return k;
    }
